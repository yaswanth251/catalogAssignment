...
const ChartComponent = () => {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", position: "relative", top: "3rem", left: "-7rem" }}>
      ...
      <div style={{ position: "absolute", fontSize: "16px", fontWeight: "bold", color: "black", borderRadius: ".4rem", padding: ".2rem", left: "42rem" ,top:"7.8rem"}}>
        ...
        <p style={{marginTop:"5rem",backgroundColor:"blue",padding:".3rem",marginLeft:"5rem",borderRadius:".3rem"}}>{lastDataPoint}</p>
      </div>
    </div>
  );
};
